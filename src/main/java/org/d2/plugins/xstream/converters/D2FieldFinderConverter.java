...
public class D2FieldFinderConverter extends AbstractReflectionConverter
{
    public static final String CURRENT_FIELD_KEY = "currentField";

    public D2FieldFinderConverter(Mapper mapper, ReflectionProvider reflectionProvider)
    {
